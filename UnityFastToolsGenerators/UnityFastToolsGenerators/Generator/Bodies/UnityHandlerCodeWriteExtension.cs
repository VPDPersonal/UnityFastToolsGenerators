...
public static class UnityHandlerCodeWriteExtension
{
    ...
    public  static void AppendUnityHandler(this CodeWriter writer, IReadOnlyList<UnityFastToolsMember<ISymbol>> members)
    {
    ...
    private static void Append(
        StringBuilder subscribe, StringBuilder unsubscribe, int minIndent, int index, UnityFastToolsMember<ISymbol> member)
    {
